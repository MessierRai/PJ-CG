...
def desenho():
   ...
   # piso()
    ...
    #cabo(translate_x, translate_y, translate_z, rotacao_x, rotacao_y, rotacao_z)
    #cabide(translate_x, translate_y, translate_z, rotacao_x, rotacao_y, rotacao_z)
    chamaTudo()
    glPushMatrix()
    glTranslate(0.4, 0, -0.4)
    glRotatef(90, 0, 1, 0)
    chamaTudo()
    glPopMatrix()
