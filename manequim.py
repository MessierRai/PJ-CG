...
def cabide(translate_x, translate_y, translate_z):
    glColor3f(1.0, 0, 1.025)
    glPushMatrix()                # Push e Pop Isolam os efeitos das transformacoes no objeto
...
def cabo(translate_x, translate_y, translate_z):
    ...
    glScalef(3, 1, 0.4)
    glRotatef(90, 0.0, 0.0, 0.1)     #Rotaçao do objeto
    glutSolidCylinder(0.01, 4.0, 50, 50)

    glPopMatrix()

def cubao(translate_x, translate_y, translate_z, rotacao_x, rotacao_y, rotacao_z, cor_R, cor_G, cor_B):
    #cubao 1
    ...
    glColor3f(0, 0, 0)
    glPushMatrix()                # Push e Pop Isolam os efeitos das transformacoes no objeto
    glTranslate(translate_x, translate_y, translate_z + 0.01)  #Transtacao do objeto
    glScale(0.2, 0.7, 0.03)
    glutSolidCube(1.0)
    glPopMatrix()

    glColor3f(0, 0, 0)
    glPushMatrix()                # Push e Pop Isolam os efeitos das transformacoes no objeto
    glTranslate(translate_x - 0.15, translate_y + 0.15, translate_z + 0.02)  #Transtacao do objeto
    glScale(0.03, 0.03, 0.01)
    ...
    glPushMatrix()
    glTranslate(translate_x - 0.15, translate_y, translate_z + 0.02)  #Transtacao do objeto
    glScale(0.03, 0.03, 0.01)
    glutSolidSphere(0.5, 50, 50)
    glPopMatrix()
